...
uint32_t mobo_srd_asm2(bool raw) {
	...
	// PA05 is GPIO. PX26 and PA05 are special purpose clock pins
...
*/		
		...
		// Using regenerated clock is not applied to USB
		if ( (!regen_used) || (source == MOBO_SRC_UAC2) ) {
