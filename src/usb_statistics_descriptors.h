...
#define USB_STATS_PACKET_WIRE_SIZE               49u
#define USB_STATS_PACKET_CHECKSUM_OFFSET         3u
#define USB_STATS_WIRE_OFFSET_BASS_BOOST_ENABLED 43u
#define USB_STATS_WIRE_OFFSET_GAIN_INFERRED_LEFT   44u
#define USB_STATS_WIRE_OFFSET_GAIN_INFERRED_RIGHT  45u
#define USB_STATS_WIRE_OFFSET_LOUDNESS_ENABLED     46u
#define USB_STATS_WIRE_OFFSET_SAMPLE_BITS          47u
#define USB_STATS_WIRE_OFFSET_NUM_SAMPLES          48u
