...
static const pdca_channel_options_t PDCA_OPTIONS = { 
	...
	.r_addr = (void *)audio_buffer,				// Was: NULL next memory address // Is this safe??
...
static const pdca_channel_options_t SPK_PDCA_OPTIONS = {
	...
	.r_addr = (void *)spk_buffer,				// Was: NULL next memory address // Safe?
...
volatile bool must_init_spk_index = TRUE;
volatile bool must_init_xo = FALSE;
volatile S32 samples_per_package_min = 0;
...
#ifdef I2S_METADATA
	volatile uint8_t i2s_meta_L = 0b10010000;	// Version 0 encoding for muted, no source
	volatile uint8_t i2s_meta_R = 0b00000111;	// Version 0 encoding for 44.1ksps XO, unknown
#endif
