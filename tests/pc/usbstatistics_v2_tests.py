...
class UsbStatisticsV2Tests(unittest.TestCase):
    def test_parse_stereo_v2_packet(self):
        stats = usbstatistics.parse_stats_payload(build_v2_payload())
    ...
    def test_reject_version_1_packet(self):
    ...
    def test_format_stereo_deltas(self):
        previous = usbstatistics.parse_stats_payload(build_v2_payload())
